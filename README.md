...
5.	Download the Dec 2017 release of the <b>AZ3166-IoT-Central-1.0.0.bin</b> file from GitHub at https://github.com/Microsoft/microsoft-iot-central-firmware/releases.  <b> NOTE: Do not download the latest release as it has an issue with receieinv the methodName commands. </b> 
